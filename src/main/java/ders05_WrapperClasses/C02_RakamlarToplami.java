...
public class C02_RakamlarToplami {
    public static void main(String[] args) {
        ...
        System.out.println(23/5); // 4,6 degil 4 verir

        System.out.println(123%10); // 3

        System.out.println(123/10); // 12.3 fakat int oldugundan tamsayi yani 12 verir.

        Scanner scan= new Scanner(System.in);
        System.out.println("Lutfen 3 basamakli pozitif bir tamsayi giriniz.");
        int sayi= scan.nextInt(); // 123 girildigini varsayarak
